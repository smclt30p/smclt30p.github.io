/* http://prismjs.com/download.html?themes=prism-okaidia&languages=clike+c+csharp+cpp+http+java&plugins=line-numbers */
                                ...
                                for (var m = 0, y = 0; m < r.length; y += (r[m].matchedStr || r[m]).length, ++m) {
                                    ...
                                    if (!(v instanceof a)) {
                                        ...
                                        if (!b && h && m != r.length - 1) {
                                            ...
                                            for (var w = b.index + (g ? b[1].length : 0), _ = b.index + b[0].length, S = m, P = y, A = r.length; A > S && _ > P; ++S) P += (r[S].matchedStr || r[S]).length, w >= P && (++m, y = P);
...
Prism.languages.java = Prism.languages.extend("clike", {
    keyword: /\b(abstract|continue|null|System.out|for|String\s|new|switch|assert|default|goto|package|synchronized|boolean|do|if|private|this|break|double|implements|protected|throw|byte|else|import|public|throws|case|enum|instanceof|return|transient|catch|extends|int|short|try|char|final|interface|static|void|class|finally|long|strictfp|volatile|const|float|native|super|while)\b/,
